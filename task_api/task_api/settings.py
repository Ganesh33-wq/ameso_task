...
SECRET_KEY = 'django-insecure-zh$otkz&*_ac^(*i2l0sddj$0u7+(q+sfy$0--&h-sqz)md)mu'
...
CORS_ALLOWED_HEADERS = [
    'pragma',  # Add 'pragma' to the allowed headers list
    'content-type',
...
DEFAULT_DATE_TIME_FORMAT_W_Z = "%Y-%m-%d %H:%M:%S"
# Database
